var mainState = {
    ...
    create: function() { 
        ...
        this.deathLabel = game.add.text(game.width-120, game.height-50, 'Deaths: 0',{ font: '18px Arial', fill: '#ffffff' });
        // Initialize the score variable
        this.deaths = 0;
    ...
    update: function() {
        ...
        if (!this.player.inWorld) {
            this.playerRespawn(this.player);
        }
        ...
        game.physics.arcade.overlap(this.player, this.enemies, this.playerEnemyCollide, null,this);
    ...
    playerEnemyCollide: function(player,enemy) {
        ...
        enemy.kill();
        this.deaths += 1;
        this.deathLabel.text = 'Deaths: ' + this.deaths;
        //enemy.destroy();
