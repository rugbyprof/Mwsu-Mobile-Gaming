...
BasicGame.Game2.prototype = {
  ...
  create: function () {
    map = this.game.add.tilemap('sewer');

    //  The first parameter is the tileset name, as specified in the Tiled map editor (and in the tilemap json file)
    //  The second parameter maps this name to the Phaser.Cache key 'tiles'
    map.addTilesetImage('sewer_tileset', 'sewer_tiles');
  ...
  update: function () {
    ...
    if(this.spr.body.x > 285 && this.spr.body.x < 370 && this.spr.body.y > 545 && this.spr.body.y < 575){
        BasicGame.life = BasicGame.life * 1.9;
