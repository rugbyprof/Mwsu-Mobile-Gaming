...
BasicGame.Preloader.prototype = {
  ...
  preload: function () {
    ...
    this.load.spritesheet('runner','assets/runner.png',128,128);
    ...
    this.load.image('road_tiles', 'assets/roads-grass.bmp');
    ...
    this.game.load.tilemap('roads', 'assets/roads-improved.json',null, Phaser.Tilemap.TILED_JSON);
    // End Map Layers
